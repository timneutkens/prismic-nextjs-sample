  ...
  renderHead() {
    return (
      <Head className={this.props.className}>
        <title>
          {RichText.asText((this.props && this.props.title) || "Not Found")}
        </title>
        <meta
          name="description"
    ...
    const headerItems = this.props.layout.data.header_nav_items.map(
      (item, index) => (
        <PrismicLink to={item.link} key={index}>
          <a onClick={this.handleClickMenuItem} className="header-nav-link">
            {item.text}
          </a>
        </PrismicLink>
      )
      ...
      <React.Fragment>
        ...
        <footer className="footer">
          <div className="footer-inner">
            <div>
              <p className="footer-name">{this.props.layout.data.site_name}</p>
