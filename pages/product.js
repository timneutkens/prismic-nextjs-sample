  ...
  renderBody() {
    return (
      ...
      >
            ...
            <div className="l-wrapper">
              <div className="product-hero-inner">
                <img
                  ...
                  src={this.props.product.data.product_image.url}
                  alt={this.props.product.data.product_image.alt}
                />
                <div className="product-hero-content">
                  <div className="product-hero-name">
                    {RichText.render(
                      this.props.product.data.product_name,
                      linkResolver
                    )}
                  </div>
                  <div className="product-hero-rich-content">
                    {RichText.render(
                      this.props.product.data.rich_content,
                      linkResolver
                    )}
                  </div>
            ...
            <div className="l-wrapper">
              <header className="products-grid-header">
                <div className="products-grid-header-title">
                  {RichText.render(
                    this.props.product.data.related_products_title,
                    linkResolver
                  )}
                </div>
              </header>
        ...
        <div data-wio-id={this.props.product.id} />
